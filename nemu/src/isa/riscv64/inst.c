...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  // multiply high
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, printf("mulh no implementation!\n"));
  // multiply high signed unsigned
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, printf("mulsh no implementation!\n"));
  // multiply high unsigned
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, printf("mulhu no implementation!\n"));
  // divide
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(dest) = (int64_t) src1 / (int64_t) src2); // no consider exceptions 1/0
  // divide word
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, s->dnpc = isa_raise_intr(0, s->pc)); // jump to exception entry address
