...
VTop__Syms::VTop__Syms(VerilatedContext* contextp, const char* namep,VTop* modelp)
    ...
    , TOP__Top__DOT__MemCtrlInst__DOT__MemInst_data(Verilated::catName(namep, "Top.MemCtrlInst.MemInst_data"))
{
    ...
    TOP.__PVT__Top__DOT__MemCtrlInst__DOT__MemInst_data = &TOP__Top__DOT__MemCtrlInst__DOT__MemInst_data;
    // Setup each module's pointer back to symbol table (for public functions)
    TOP.__Vconfigure(this, true);
    TOP__Top__DOT__IFUInst__DOT__MemVirtualInst_instr.__Vconfigure(this, true);
    TOP__Top__DOT__MemCtrlInst__DOT__MemInst_data.__Vconfigure(this, false);
